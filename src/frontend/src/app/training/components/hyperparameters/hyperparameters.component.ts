...
export class HyperparametersComponent implements OnInit 
{
  ...
  ngOnInit(): void 
  {
    ...
    //   metricFormControl: new FormControl('')
    // });
  }
  ...
  // togglePerOne(all){ 
  //   if (this.allMetricsSelected.selected) {  
  //    this.allMetricsSelected.deselect();
  //    return false;
  //   }
  //  if(this.formGroup.controls.metricFormControl.value.length==this.metrics.length)
  //    this.allMetricsSelected.select();
 
  // }  
  // toggleAllSelection() {
  //   if (this.allMetricsSelected.selected) {
  //     this.formGroup.controls.metricFormControl
  //       .patchValue([...this.metrics.map(item => item.codename), 0]);
  //   } else {
  //     this.formGroup.controls.metricFormControl.patchValue([]);
  //   }
  // }
