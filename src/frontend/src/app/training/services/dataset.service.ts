...
export class DatasetService {
  ...
  uploadLink(source: string): Observable<any[]> {
    return this.http.post<any>(this.datasetAPIUrl + '/uploadLink?url=' + source, null).pipe(
      tap(_ => console.log(`uploaded link`)),
      catchError(this.handleError<any>('uploadLink'))
    );
  }
